...
# 在测试模块导入应用代码之前，先固定一组最小可用环境变量，
# 避免测试依赖本机 `.env` 或空环境的偶然状态。
os.environ.setdefault("REFRESH_TOKEN", "test_refresh_token_abcdef")
os.environ.setdefault("PROXY_API_KEY", "test_proxy_key_12345")
os.environ.setdefault("PROFILE_ARN", "arn:aws:codewhisperer:us-east-1:123456789:profile/test")
...
def block_all_network_calls():
    ...
    patchers = [
        ...
        patch('main.httpx.AsyncClient', return_value=mock_async_client),
    ]
